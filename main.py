...
sprint_less_used, sprint_most_used = usage.check_data_usage()
...
try:
    ...
    emails.send_daily_report(email_conn, errors, customers_to_close, problem_list, sold_today, sprint_less_used, sprint_most_used)
