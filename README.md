# Notifier
Program helps send customer due date reminders, create various reports, notify about google sheets possible errors, control mobile data usage.
...
- Keeps track of list of broken lines and sets repair priority. Once a week employee made broken lines report and set priorities to fix them.
...
### Result
Programm starts daily at 12:01 am. When finished it sends reports to manager, support department along with payment reminders for clients.
